 ...
 * 
 */
@WebServiceClient(name = "FileServerImplWSService", targetNamespace = "http://srv.tp1.sd/", wsdlLocation = "http://localhost:8084/FileServer?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8084/FileServer?wsdl");
